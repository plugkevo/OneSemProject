        ...
        <table class="table table-striped table-hover table-responsive"  >
                ...
                <tbody>    
                    <tr>  
                        ...
                        <td style="width:100px; margin-left:20%; padding-right: 20%;"> <?php echo $row['name']  ?></td>
                        <td style="j"> <?php echo $row['price']  ?></td>
                        <td> 
                          <input type="text" name="quantity" style="width: 50px;" value="1" class="form-control" /> 
						</td>
